...
public sealed class PesquisaEntity()
{
    /// <summary>
    ...
    internal PesquisaEntity(string? codigo, DateTimeOffset? inicio, DateTimeOffset? fim) : this()
    {
        Codigo = codigo;
        Inicio = inicio;
        Fim = fim;
    ...
    /// </summary>
    public List<PerguntaEntity>? Perguntas { get; init; } = [];
    ...
    /// <summary>
    /// Adiciona uma perguntaEntity à pesquisa.
    /// </summary>
    /// <param name="perguntaEntity">A perguntaEntity a ser adicionada.</param>
    public void AddPergunta(PerguntaEntity perguntaEntity) => Perguntas?.Add(perguntaEntity);
